...
% Purpose: To test that the terminal settling velocity is independent of
...
Initial_Vel = [10, 1, 0.1, 0.01, 0.001, 0.000001];

wvel_BB(:, 1) = Initial_Vel(1);
...
Results_BB_10 = zeros(140, 11);

for i=1:140
    Results_BB_10(i, 1) = d_equi(i);
    Results_BB_10(i, 2) = CSF(i);
    Results_BB_10(i, 3) = wtFinal_BB(i);
    Results_BB_10(i, 4) = wvel_meas(i);
    Results_BB_10(i, 5) = FinalTime_BB(i);
    Results_BB_10(i, 6) = DistTot_BB(i);
    Results_BB_10(i, 7) = timestep;
    Results_BB_10(i, 8) = Reynolds(i);
    Results_BB_10(i, 9) = ReFinal_BB(i);
    Results_BB_10(i, 10) = Cd_meas(i);
    Results_BB_10(i, 11) = CdFinal_BB(i);
end 

Table_BB_SA = array2table(Results_BB_10, "VariableNames", ...
...
%%
writetable(Table_BB_SA, './DragModelsTest/Output/20220517/InitialVelocity/BagheriOutputVM_SA_Init.txt', 'Delimiter', ',', 'WriteRowNames', true);
writetable(Table_BB_SA, './DragModelsTest/Output/20220517/InitialVelocity/BagheriOutputVM_SA.xls', 'WriteRowNames', true);
