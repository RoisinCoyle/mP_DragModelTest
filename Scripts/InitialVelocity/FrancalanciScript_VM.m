...
exportgraphics(gcf, './DragModelsTest/Output/20220517/FrancalanciVM_ESDVsW.jpg', 'Resolution', 300)
...
set(gcf, 'WindowState', 'maximized');
exportgraphics(gcf, './DragModelsTest/Output/20220517/FrancalanciVM_ESDVsW_Shapes.jpg', 'Resolution', 300)
...
set(gcf, 'WindowState', 'maximized');
exportgraphics(gcf, './DragModelsTest/Output/20220517/FrancalanciVM_CSFVsW.jpg', 'Resolution', 300);
...
set(gcf, 'WindowState', 'maximized');
exportgraphics(gcf, './DragModelsTest/Output/20220517/FrancalanciVM_CSFVsW_Shapes.jpg', 'Resolution', 300);
...
set(gcf, 'WindowState', 'maximized');
exportgraphics(gcf, './DragModelsTest/Output/20220517/FrancalanciVM_MeasVsCalc.jpg', 'Resolution', 300);
...
set(gcf, 'WindowState', 'maximized');
exportgraphics(gcf, './DragModelsTest/Output/20220517/FrancalanciVM_MeasVsCalc_Eqn.jpg', 'Resolution', 300);
...
set(gcf, 'WindowState', 'maximized');
exportgraphics(gcf, './DragModelsTest/Output/20220517/FrancalanciVM_MeasVsCalc_Fit.jpg', 'Resolution', 300);
