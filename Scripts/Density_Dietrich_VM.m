...
d_dim = zeros(63, 1);
wdim_Dietrich = zeros(63, 1);
wt_Dietrich = zeros(63, 1);
R1 = zeros(63,1);
R2 = zeros(63,1);
R3 = zeros(63,1);
g=9.81;
...
writetable(Table_Dietrich, './DragModelsTest/Output/20220517/Density/DietrichOutputVM_Den.txt', 'Delimiter', ',', 'WriteRowNames', true);
writetable(Table_Dietrich, './DragModelsTest/Output/20220517/Density/DietrichOutputVM_Den.xls', 'WriteRowNames', true);
...
writetable(Table_Dietrich_NaN, './DragModelsTest/Output/20220517/Density/DietrichOutputVM_NaNDensity.txt', 'Delimiter', ',', 'WriteRowNames', true);
writetable(Table_Dietrich_NaN, './DragModelsTest/Output/20220517/Density/DietrichOutputVM_NaNDensity.xls', 'WriteRowNames', true);
...
plot(Table_Dietrich{43:63, "FluidDensity"}, Table_Dietrich{43:63, "Wt_Calc"}, 'og', ...
